...
这几天都在完成数据结构和C++的试卷 15.47

## 3-17：星期日

完成了数据结构、C语言、C++试卷 20.50

看数据库和简历 21.40

## 3-19：星期二

复习专业课问答题，和redis数据库的内容 21.39

## 3-20：星期三

复习C++试卷错题 11.45

下午计划：复习数据结构、复试经验四、五、六：Linux命令 13.02

写了三个数据结构代码题、复习Linux命令 20.30
